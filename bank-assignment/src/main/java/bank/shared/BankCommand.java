...
public interface BankCommand<T extends BankAnswer<? extends Serializable>> extends Serializable {
	...
	public static class BankAccountCloseCommand extends BankAccountCommand<BooleanAnswer> {
		private static final long serialVersionUID = 1L;
	...
	public static class BankAccountExistsCommand implements BankCommand<BooleanAnswer> {
		private static final long serialVersionUID = 1L;
		...
		public BooleanAnswer execute(ServerBank bank) throws Exception {
			return new BooleanAnswer(bank.getAccount(number) != null);
		}
	}
